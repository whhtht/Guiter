...
const SignUp: React.FC = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(error)
      const { status } = error as ErrorResponse;
      if (status === 400) {
          ...
          <Grid item xs={6} sm={6} md={6} lg={6} xl={6}>
            ...
            >
                ...
                >
                  ...
                  {/* Error Message */}
                  {error && (
                      <Typography color="red" variant="body2" sx={{ visibility: 'visible', height: '1%' }}>
                          {error}
                      </Typography>
                  )}
                  {message && (
                    <Typography color="green" variant="body2" sx={{ visibility: 'visible', height: '1%' }}>
                      {message}
                    </Typography>
                  )}
                  {/* Remember Me */}
